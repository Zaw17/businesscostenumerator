...
print("The selling price in dollars")
...
print(f'The break even unit is {num1/(num4-(num2/num3))}')

print(f'The break even revenue is ${(num1/(num4-(num2/num3)))* num4}')

print(f'Your profit in percents is {(((num4-((num1+num2)/num3))/((num1+num2)/num3)*100))}%')
